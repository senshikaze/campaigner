...
import { AuthClientConfig, AppState } from '@auth0/auth0-angular/lib/auth.config';
import { AuthState } from '@auth0/auth0-angular/lib/auth.state';
import { LogoutOptions, RedirectLoginOptions } from '@auth0/auth0-angular/lib/interfaces';
